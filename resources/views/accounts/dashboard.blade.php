...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold text-gray-800 text-center mb-6">Accounts & Audit Dashboard</h1>
    ...
    @if($registrations->isEmpty())
        <div class="text-center p-6 bg-white rounded-lg shadow">
            <p class="text-lg text-gray-600">No pending audits.</p>
        </div>
    @else
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-center">
                            <form action="{{ route('registrations.audit', $registration->id) }}" method="POST">
                                @csrf
                                <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded-lg shadow hover:bg-blue-600 focus:outline-none">
                                    Verify Documents
                                </button>
                            </form>
                        </td>
