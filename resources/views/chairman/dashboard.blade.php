...
<div class="container mx-auto px-4 py-6">
    <h1 class="text-3xl font-bold text-gray-800 text-center mb-6">Chairman Dashboard</h1>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Membership No.</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">{{ $registration->membership_number ?? 'Not Assigned' }}</td>
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('chairman.show', $registration->id) }}" 
